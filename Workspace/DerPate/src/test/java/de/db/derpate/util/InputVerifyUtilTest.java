...
public class InputVerifyUtilTest {
	...
	@Test
	public void testHasAtLeastXCharacters() {
		String test = "test";
		assertTrue(InputVerifyUtil.hasAtLeastXCharacters(test, -1));
		assertTrue(InputVerifyUtil.hasAtLeastXCharacters(test, 0));
		assertTrue(InputVerifyUtil.hasAtLeastXCharacters(test, 3));
		assertTrue(InputVerifyUtil.hasAtLeastXCharacters(test, 4));

		assertFalse(InputVerifyUtil.hasAtLeastXCharacters(test, 5));
		assertFalse(InputVerifyUtil.hasAtLeastXCharacters(null, -1));
		assertFalse(InputVerifyUtil.hasAtLeastXCharacters(null, 0));
		assertFalse(InputVerifyUtil.hasAtLeastXCharacters(null, 1));
	}
