...
INSERT INTO `godfather` (`Id_Godfather`, `Email`, `Password`, `Last_Name`, `First_Name`, `Id_Location`, `Max_Trainees`, `Description`, `Id_Job`, `Hiring_Date`, `Birthday`, `Pick_Text`) VALUES
